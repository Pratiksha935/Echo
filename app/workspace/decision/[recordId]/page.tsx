...
export default async function DecisionTimelinePage({params}:{params:Promise<{recordId:string}>}) {
  ...
  const askFoundHref=`/workspace?ask=${encodeURIComponent(`What did we decide about ${decision.title}?`)}`;
